...
" support fsc for faster compilation? - consider using ensime / sbt instead
call actions#AddAction('scalac current file', {'action': funcref#Function('actions#CompileRHSSimple', 
      \ {'args': [   ['set ef=set errorformat=(fragment\ of\ %f):%l:\ %m']
                 \ , ["scalac", funcref#Function('return expand("%")')]
                 \ ]})})
call actions#AddAction('fsc current file', {'action': funcref#Function('actions#CompileRHSSimple', 
      \ {'args': [   ['set ef=set errorformat=(fragment\ of\ %f):%l:\ %m']
                 \ , ["fsc", funcref#Function('return expand("%")')]
                 \ ]})})
...
call actions#AddAction('scala run compiled current file', {'action': funcref#Function('actions#CompileRHSSimple',
  \ {'args': [ [], ["scala", funcref#Function("return vim_addon_scala#PackageName('.').matchstr(filter(getline(0,line('$')),'v:val=~ '.string('^\\s*object '))[0],'object \\zs\\S*\\ze')")] ]})})
